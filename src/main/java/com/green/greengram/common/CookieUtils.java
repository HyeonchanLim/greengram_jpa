...
public class CookieUtils {
    ...
    public <T> T getValue(HttpServletRequest request, String name, Class<T> valueType){
    ...
    private String serialzeObject(Object obj){
        return Base64.getUrlEncoder().encodeToString(SerializationUtils.serialize(obj));
    }

    // deserialize - 역직렬화 , 문자열값을 객체로 변환
    ...
    public void setCookie(HttpServletResponse res, String name , Object value , int maxAge , String path){
        this.setCookie(res,name,serialzeObject(value),maxAge,path);
    }
